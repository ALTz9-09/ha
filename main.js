...
const MESSAGE = [
    "Nhân dịp ngày quốc tế phụ nữ 8/3, tập thể các bạn nam lớp 11/10 mong muốn gửi tới những nàng công chúa của lớp những lời chúc tốt đẹp nhất. Chúng mình mong các bạn sẽ luôn giữ được nụ cười trên môi, sẽ luôn xinh đẹp rạng ngời. Chúc bạn Hồng Anh 8386, vạn sự như ý, triệu sự như mơ, tỉ sự bất ngờ và hàng giờ hạnh phúc. Cảm ơn Hồng Anh vì đã đồng hành cùng với lớp nói chung và chúng tớ nói riêng trong suốt một khoảng thời gian không dài nhưng cũng đủ để có những kỉ niệm đẹp cùng nhau. Hy vọng trong thời gian tới, như gần nhất là trại, chúng ta sẽ cùng nhau có thêm thật nhiều kỉ niệm với nhau nữa nè. Một lần nữa, chúc Hồng Anh một ngày 8/3 thật vui vẻ và hạnh phúc nhé!",
    "    Hồng Anh",
